        ...
        <div className="container">
            <div className="form">
                ...
                <form>
                    ...
                    <br></br>
                    {errors.username?.type=="maxLength"&&<span style={{color : "red"}}>Max characters should be 80</span>}
                    </Form.Group>
                    ...
                    <br></br>
                    {errors.confirmPassword?.type =="minLength"&&<span style ={{color : "red"}}>Min characters should be 80</span>}
                    </Form.Group>
                    <br></br>
                    <Form.Group>
